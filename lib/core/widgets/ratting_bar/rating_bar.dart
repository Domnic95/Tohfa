...
///
/// [RatingBar2] can also be used to display rating
///
...
class RatingBar2 extends StatefulWidget {
  /// Creates [RatingBar2] using the [ratingWidget].
  const RatingBar2({super.key,
  ...
  /// Creates [RatingBar2] using the [itemBuilder].
  const RatingBar2.builder({
  ...
  /// How the item within the [RatingBar2] should be placed in the main axis.
  ///
  ...
  @override
  _RatingBar2State createState() => _RatingBar2State();
}

class _RatingBar2State extends State<RatingBar2> {
  double _rating = 0.0;
  bool _isRTL = false;
  ...
  @override
  void didUpdateWidget(RatingBar2 oldWidget) {
...
class _NoRatingWidget extends StatelessWidget {
  _NoRatingWidget({
    ...
    required this.enableMask,
    required this.unratedColor,
    this.useOutline = true, // Add this parameter
  });
  ...
  final bool enableMask;
  final Color unratedColor;
  final bool useOutline; // New parameter to control outline vs filled
    ...
    return SizedBox(
      ...
      child: FittedBox(
        ...
        child: enableMask
            ? useOutline
            ? Icon(
          Icons.star_border, // Use outlined star
          color: unratedColor,
          size: size,
        )
            : ColorFiltered(
