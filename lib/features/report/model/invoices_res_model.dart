...
InvoicesResModel invoicesResModelFromJson(String str) =>
    InvoicesResModel.fromJson(json.decode(str));

String invoicesResModelToJson(InvoicesResModel data) =>
    json.encode(data.toJson());

class InvoicesResModel {
  ...
  factory InvoicesResModel.fromJson(Map<String, dynamic> json) =>
      InvoicesResModel(
        data: json["data"] == null
            ? []
            : List<InvoiceModel>.from(json["data"]!.map((x) => InvoiceModel.fromJson(x))),
      );
...
class InvoiceModel {
  ...
  String? customerBillEmail;
  String? billAddress;
  dynamic customerBillGstin;
  String? customerBillGstState;
  String? shipAddress;
  dynamic customerShipGstin;
  String? customerShipGstState;
  dynamic agent;
  String? termName;
  String? siteAddress1;
  String? customerName;
  ...
  factory InvoiceModel.fromJson(Map<String, dynamic> json) => InvoiceModel(
        ...
        basicValue: json["basicValue"]?.toDouble(),
